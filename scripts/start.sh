...
mpirun -np 4 ./build/NMOSF 2>&1 | tee log.log
#mpirun -np 1 valgrind --leak-check=full --leak-resolution=med --show-leak-kinds=all --track-origins=yes ./build/NMOSF 2>&1 | tee log.log
#./build/NMOSF
