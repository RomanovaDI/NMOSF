...
mpirun -np 2 ./build/NMOSF 2>&1 | tee result/log.log
#mpirun -np 3 valgrind --leak-check=full --leak-resolution=med --show-leak-kinds=all --track-origins=yes ./build/NMOSF 2>&1 | tee log.log
#./build/NMOSF
