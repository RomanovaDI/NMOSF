...
plot [450:800]		3.83 * 0.0000001 / (1 / x - 0.00117)		w l ls 2 title 'Вязкость нефти'
...
plot [450:800]		3.83 * 0.0000001 / (1 / x - 0.000117)		w l ls 2 title 'Вязкость нефти'
...
plot [500:1200]		3.83 * 0.0000001 / (1 / ((850 + (20000000 - 1000000) / (1300 * 1300))/(1 + 0.0008701 * (x - 330))) - 0.00117)	w l ls 2 title 'Вязкость нефти'
...
plot [500:1200]		3.83 * 0.0000001 / (1 / ((850 + (20000000 - 1000000) / (1300 * 1300))/(1 + 0.0008701 * (x - 330))) - 0.000117)	w l ls 2 title 'Вязкость нефти'
