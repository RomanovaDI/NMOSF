...
plot	[380:700]	(998 + (20000000 - 1000000) / (1400 * 1400))/(1 + 0.0011 * (x - 330))	w l ls 1 title 'Плотность воды при p = 2*10^7 Па', \
...
plot	[380:700]	(850 + (20000000 - 1000000) / (1300 * 1300))/(1 + 0.0008701 * (x - 330))	w l ls 1 title 'Плотность нефти при p = 2*10^7 Па', \
...
plot	[380:700]	(998 + (20000000 - 1000000) / (1400 * 1400))/(1 + 0.0011 * (x - 300))	w l ls 1 title 'Плотность воды при p = 2*10^7 Па', \
...
plot	[380:700]	(850 + (20000000 - 1000000) / (1300 * 1300))/(1 + 0.0008701 * (x - 300))	w l ls 1 title 'Плотность нефти при p = 2*10^7 Па', \
...
plot	[380:700]	20000000 * 4 / (8.314 * x * (1. / 0.02801 + 1. / 0.032 + 1. / 0.04401 + 1. / 0.01802))	w l ls 1 title 'Плотность газа при p = 2*10^7 Па', \
