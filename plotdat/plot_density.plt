...
plot	[380:900]	(998 + (20000000 - 1000000) / (1400 * 1400))/(1 + 0.0011 * (x - 300))	w l ls 1 title 'Плотность воды при p = 2*10^7 Па', \
					...
					(998 + (1000000 - 1000000) / (1400 * 1400))/(1 + 0.0011 * (x - 300))	w l ls 3 title 'Плотность воды при p = 10^6 Па'
set title "Зависимость плотности нефти от температуры"
...
plot	[380:900]	(850 + (20000000 - 1000000) / (1300 * 1300))/(1 + 0.0008701 * (x - 300))	w l ls 1 title 'Плотность нефти при p = 2*10^7 Па', \
					...
					(850 + (1000000 - 1000000) / (1300 * 1300))/(1 + 0.0008701 * (x - 300))		w l ls 3 title 'Плотность нефти при p = 10^6 Па'
set title "Зависимость плотности нефти от температуры"
