...
set style line 2 lc 3 lt 1 dt 2 lw 4
...
#set logscale y
#plot	'termo_on1/result/velocity_of_oil_production_kg.dat' using ($1/3600.0):($2*36.0) with lines ls 1 title "с термогазом", \
#		'termo_off/result/velocity_of_oil_production_kg.dat' using ($1/3600.0):($2*36.0) with lines ls 2 title "простое вытеснение"
...
#plot	'termo_on1/result/oil_production_kg.dat' using ($1/3600.0):($2/10.0) with lines ls 1 title "с термогазом", \
#		'termo_off/result/oil_production_kg.dat' using ($1/3600.0):($2/10.0) with lines ls 2 title "простое вытеснение"
...
#set logscale y
#set key right top
#plot	'termo_on1/result/velocity_of_oil_production_m.dat' using ($1/3600.0):($2*36.0) with lines ls 1 title "с термогазом", \
#		'termo_off/result/velocity_of_oil_production_m.dat' using ($1/3600.0):($2*36.0) with lines ls 2 title "простое вытеснение"
...
#unset logscale y
#set key right bottom
#plot	'termo_on1/result/oil_production_m.dat' using ($1/3600.0):($2/10.0) with lines ls 1 title "с термогазом", \
#		'termo_off/result/oil_production_m.dat' using ($1/3600.0):($2/10.0) with lines ls 2 title "простое вытеснение"
