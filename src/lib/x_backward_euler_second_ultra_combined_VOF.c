...
int GRAD_pressure_backward_euler_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
...
int DIV_density_velocity_velocity_backward_euler_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
	int s, pr;
	double A_value;
...
int DIV_density_velocity_backward_euler_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
	int s, pr;
	double A_value;
...
int DIV_shear_stress_linear_backward_euler_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
...
int VECT_barotropy_pressure_backward_euler_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
	double A_value, c1;
	c1 = 10;//0.001;
