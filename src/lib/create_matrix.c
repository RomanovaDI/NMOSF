...
int set_concentration_equation(in *I, int p, int i, int j, int k, int flag_creating)
{
	if (flag_creating) {
		...
		if (DIV(p, i, j, k, concentration_average_velocity_gas_divide_by_saturation_gas_porousness, backward_euler, second, separated, FDM, termogas)) return 1;
...
int set_pressure_equation(in *I, int p, int i, int j, int k, int flag_creating)
{
	if (flag_creating) {
		...
		if ((1) && (!(well(I, i, j, k))) && (I->marker_of_step % 2 == 0)) {
		//if ((1) && (!(well(I, i, j, k)))) {
		//	if (DDT(p, i, j, k, coef_pressure, second, separated, FDM, termogas)) return 1;
			if (LAPL(p, i, j, k, coef_pressure, backward_euler, second, separated, FDM, termogas)) return 1;
		} else {
...
int set_saturation_equation(in *I, int p, int i, int j, int k, int flag_creating)
{
	if (flag_creating) {
		if (DDT(p, i, j, k, saturation, second, separated, FDM, termogas)) return 1;
		if (DDT(p, i, j, k, arithmetic_mean_of_neighboring_cells, second, separated, FDM, termogas)) return 1;
		if (DIV(p, i, j, k, saturation_average_velocity_divide_by_saturation_porousness, backward_euler, second, separated, FDM, termogas)) return 1;
		if (SCAL(p, i, j, k, mass_inflow_rate, backward_euler, second, separated, FDM, termogas)) return 1;
	} else {
		//if (I->equation_num == 1) {
		if ((1) && (I->marker_of_step % 2 == 1)) {
...
int set_temperature_flow_equation(in *I, int p, int i, int j, int k, int flag_creating)
{
	if (flag_creating) {
...
int set_temperature_environment_equation(in *I, int p, int i, int j, int k, int flag_creating)
{
	if (flag_creating) {
...
////////////////////concentration equation
					for (p = 0; p < 4; p++) {
						...
						set_concentration_equation(I, p, i, j, k, 1);
					}
////////////////////pressure equation
					p = 4;
					if (I->flag_first_time_step) {
					...
					set_pressure_equation(I, p, i, j, k, 1);
////////////////////saturation equation
					for (p = 5; p < 8; p++) {
						if (I->flag_first_time_step) {
							if (I->Ajptr_csr[I->A_ind_current] != -1)
						...
						set_saturation_equation(I, p, i, j, k, 1);
					}
////////////////////temperature flow equation
					...
					set_temperature_flow_equation(I, p, i, j, k, 1);
////////////////////temperature environment equation
					...
					set_temperature_environment_equation(I, p, i, j, k, 1);
				}
			}
		}
	}
...
////////////////////concentration equation
					for (p = 0; p < 4; p++)
						set_concentration_equation(I, p, i, j, k, 0);
////////////////////pressure equation
					p = 4;
					set_pressure_equation(I, p, i, j, k, 0);
////////////////////saturation equation
					for (p = 5; p < 8; p++)
						set_saturation_equation(I, p, i, j, k, 0);
////////////////////temperature flow equation
					p = 8;
					set_temperature_flow_equation(I, p, i, j, k, 0);
////////////////////temperature environment equation
					p = 9;
					set_temperature_environment_equation(I, p, i, j, k, 0);
				}
			}
		}
	}
