...
int GRAD_pressure_backward_euler_second_ultra_combined_VOF_avalanche(in *I, int p, int i, int j, int k)
{
...
int DIV_density_velocity_velocity_backward_euler_second_ultra_combined_VOF_avalanche(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
	int s, pr;
	double A_value;
	for (s = 0; s < 6; s++) {
		for (pr = 0; pr < 3; pr++) {
			A_value = (I->area[AREA_IND(I, i, j, k, s)] / (2 * 3 * I->volume[VOLUME_IND(I, i, j, k)])) * velocity_on_face(I, pr, i, j, k, s) *
				velocity_on_face(I, p, i, j, k, s) * I->normal[NORMAL_IND(I, pr, i, j, k, s)];
			WRITE_TO_A(3, i, j, k, -1);
			WRITE_TO_A(3, i, j, k, s);
			A_value = (I->area[AREA_IND(I, i, j, k, s)] / (2 * 3 * I->volume[VOLUME_IND(I, i, j, k)])) * density_on_face(I, i, j, k, s) *
				velocity_on_face(I, p, i, j, k, s) * I->normal[NORMAL_IND(I, pr, i, j, k, s)];
...
int DIV_density_velocity_backward_euler_second_ultra_combined_VOF_avalanche(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
	int s, pr;
	double A_value;
	for (s = 0; s < 6; s++) {
		for (pr = 0; pr < 3; pr++) {
			A_value = (I->area[AREA_IND(I, i, j, k, s)] / (2 * 2 * I->volume[VOLUME_IND(I, i, j, k)])) * density_on_face(I, i, j, k, s) *
				I->normal[NORMAL_IND(I, pr, i, j, k, s)];
			WRITE_TO_A(pr, i, j, k, -1);
			WRITE_TO_A(pr, i, j, k, s);
			A_value = (I->area[AREA_IND(I, i, j, k, s)] / (2 * 2 * I->volume[VOLUME_IND(I, i, j, k)])) * velocity_on_face(I, pr, i, j, k, s) *
				I->normal[NORMAL_IND(I, pr, i, j, k, s)];
			WRITE_TO_A(3, i, j, k, -1);
			WRITE_TO_A(3, i, j, k, s);
		}
...
int DIV_shear_stress_linear_backward_euler_second_ultra_combined_VOF_avalanche(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
...
int VECT_barotropy_pressure_backward_euler_second_ultra_combined_VOF_avalanche(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
	double A_value, c1;
	c1 = 10;//0.001;
