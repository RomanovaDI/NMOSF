...
int set_parameters_termogas(in *I)
{
	...
	I->specific_heat[0] = 1;//4180.6; // water
	I->specific_heat[1] = 1;//2500;//1800; // oil
	I->specific_heat[2] = 1;//1040; // N2
	I->specific_heat[3] = 1;//918; // O2
	I->specific_heat[4] = 1;//820; // CO2
	I->specific_heat[5] = 1;//2078.4; // H2O(g)
	I->specific_heat[6] = 1;//1000; // environment
	...
	I->adiabatic_exponent[2] = 1;//1.4; // N2
	I->adiabatic_exponent[3] = 1;//1.4; // O2
	I->adiabatic_exponent[4] = 1;//1.35; // CO2
	I->adiabatic_exponent[5] = 1;//1.3; // H2O(g)
