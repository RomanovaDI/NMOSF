...
int DDT_density_velocity_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
...
int DDT_density_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
	double A_value;
	A_value = 1 / I->dt;
...
int DDT_pressure_cont_second_ultra_combined_VOF(in *I, int p, int i, int j, int k)
{
	if (check_for_corrupt_cell(I, i, j, k)) return 1;
